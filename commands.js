...
const fs = require('fs');
const ownerNumber = ['963952556062']
const prefix = '.'
...
mek = mek.messages[0]
      ...
      case 'بوت':
		...
		await conn.sendMessage(from , { audio : fs.readFileSync("./src/alive.mpeg") , mimetype : 'audio/mpeg' , ptt: true  } , { quoted: mek })
              var alivemsg = ''
              if (config.ALIVEMSG == 'default') alivemsg = '```👋 Hi! I am online now. مرحبا أنا البوت مايكي متصل الان في خدمتك سيدي😉```'
...
await conn.sendMessage(from , { text: 'error' }, { quoted: mek } )  
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
    ...
    const listMessage = {
      text: " \n\n name : " + q + '\n\n ',
      footer: config.FOOTER,
      title: '🔱Mikey 𝙱𝙾𝚃🔱 تحميل التطبيقات',
...
╰────────────────────╯
  ...
  // _ _ _ _ _ _ _ _ __  _ _ _ _ _ _  __  _ _ _ __ _  __ _  _ _ _ _ __ _ _  __  __ _  _ __  _ __ _ _ _  _ __ _  _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ __  __ _  __ _ _ _ _   //   		      
		...
		const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + `FN:` + ' 🄺🄷🄰🄻🄴🄳 ' + `\n` // full name
            + 'TEL;type=CELL;type=VOICE;waid=' + '963952556062' + ':+' + '963952556062' + '\n' // WhatsApp ID + phone number
            + 'END:VCARD'
